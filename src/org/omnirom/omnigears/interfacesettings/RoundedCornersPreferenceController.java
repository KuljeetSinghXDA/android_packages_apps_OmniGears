...
public class RoundedCornersPreferenceController extends AbstractPreferenceController implements
    ...
    public String getPreferenceKey() {
        return OMNI_SYSUI_ROUNDED_SIZE;
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mCornerRadius = (SeekBarPreference) screen.findPreference(OMNI_SYSUI_ROUNDED_SIZE);
        int cornerRadius = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.OMNI_SYSUI_ROUNDED_SIZE, 25);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mCornerRadius) {
            ...
            Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.OMNI_SYSUI_ROUNDED_SIZE, value * 1);
        }
        return true;
    }
}
