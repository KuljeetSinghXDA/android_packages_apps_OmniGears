...
public class ContentPaddingPreferenceController extends AbstractPreferenceController implements
    ...
    public String getPreferenceKey() {
        return OMNI_SYSUI_ROUNDED_CONTENT_PADDING;
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mContentPadding = (SeekBarPreference) screen.findPreference(OMNI_SYSUI_ROUNDED_CONTENT_PADDING);
        int contentPadding = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.OMNI_SYSUI_ROUNDED_CONTENT_PADDING, 10);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mContentPadding) {
            ...
            Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.OMNI_SYSUI_ROUNDED_CONTENT_PADDING, value * 1);
        }
        return true;
    }
}
